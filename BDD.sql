...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-12-2016 a las 15:08:21
...
--
-- Estructura de tabla para la tabla `calendariovacunacion`
--

CREATE TABLE `calendariovacunacion` (
  `idCalendario` int(11) NOT NULL,
  `CODEDAD` int(11) NOT NULL,
  `idesquemavac` int(11) NOT NULL,
  `CODVACUNA` int(11) NOT NULL,
  `CODDOSIS` int(11) NOT NULL,
  `FECHAPROXIMA` date NOT NULL,
  `CODPROXIMAVACUNA` int(11) NOT NULL,
  `CODPROXIMADOSIS` int(11) NOT NULL,
...
('1', '8989', 'lopez', 'juan', 'Hombre', 1, 'Colombiano', '3', 'Esmeraldas', 'Esmeraldas', 'Esmeraldas', 'Bartolomé Ruíz', 'Esmeraldas', 'codesa', '111', '111', '09090909099', 'lopez@gmail.com', 'SI', 3);
...
CREATE TABLE `escenariovac` (
  ...
  `LUGARVACUNACION` varchar(50) NOT NULL
...
(1, 'NIÑOS/AS MENORES (de 1 año)');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `esquemavac`
--

CREATE TABLE `esquemavac` (
  `idesquemavac` int(11) NOT NULL,
  `esquemavac` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `esquemavac`
--

INSERT INTO `esquemavac` (`idesquemavac`, `esquemavac`) VALUES
(1, 'NIÑOS/AS MENORES (de 1 año)'),
(2, 'NIÑOS/AS (de 12 a 23 meses)'),
(3, 'ADOLESCENTES (10 a 15 años)'),
(4, 'POBLACIÓN (15 a 45 años)'),
(5, 'INCOMPLETO - NIÑOS/AS (de 1 a 4 años)'),
(6, 'NIÑOS (5 a 9 años)'),
(7, 'ADULTOS MAYORES (65 años y más)'),
(8, 'GRUPOS DE RIESGO'),
...
INSERT INTO `establecimiento` (`UNICODIGOES`, `NOMBREESTABLECIMIENTO`, `CODDISTRITO`, `CODZONAUBIC`, `TIPOESTABLECIMIENTO`, `CODPARROQUIA`, `LOCALIDADEST`, `CODCANTON`, `CODPROVINCIA`, `CODZONA`) VALUES
('601', 'Unidos Somos Más', '08D01', 2, 'Sub Centro de Salud', '01', 'USM', '01', '08', 1);
...
--
-- Estructura de tabla para la tabla `nombreestablecimiento`
--

CREATE TABLE `nombreestablecimiento` (
  `idNombreEstablecimiento` int(11) NOT NULL,
  `nombreEstalecimiento` varchar(80) NOT NULL,
  `idDistrito` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `nombreestablecimiento`
--

INSERT INTO `nombreestablecimiento` (`idNombreEstablecimiento`, `nombreEstalecimiento`, `idDistrito`) VALUES
(1, 'Unidos Somos Más', '08D01');
...
--
-- Indices de la tabla `calendariovacunacion`
--
...
--
-- Indices de la tabla `esquemavac`
--
ALTER TABLE `esquemavac`
  ADD PRIMARY KEY (`idesquemavac`);
...
ALTER TABLE `establecimiento`
  ...
  ADD KEY `CODCANTON` (`CODCANTON`),
  ADD KEY `CODPROVINCIA` (`CODPROVINCIA`),
  ADD KEY `CODCANTON_2` (`CODCANTON`),
  ADD KEY `LOCALIDADEST` (`LOCALIDADEST`),
  ADD KEY `CODPROVINCIA_2` (`CODPROVINCIA`);
...
--
-- Indices de la tabla `nombreestablecimiento`
--
ALTER TABLE `nombreestablecimiento`
  ADD PRIMARY KEY (`idNombreEstablecimiento`);
...
--
-- AUTO_INCREMENT de la tabla `calendariovacunacion`
--
ALTER TABLE `calendariovacunacion`
...
--
-- AUTO_INCREMENT de la tabla `tarj_controlvacs`
--
ALTER TABLE `tarj_controlvacs`
  MODIFY `CODTARCONTVAC` int(11) NOT NULL AUTO_INCREMENT;
--
