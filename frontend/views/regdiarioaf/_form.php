...
$.get('index.php?r=regdiarioaf/listado-vacunador', function(data){
...
$('#regdiario-codlugarvacunacion').change(function(){
  var idEstablecimiento = $(this).val();
  $.get('index.php?r=regdiarioaf/listado-institucion', {id : idEstablecimiento}, function(data){
...
function ciudadano(idCiudadano){
  ...
  $.get('index.php?r=regdiarioaf/nombre-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-nombresciudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/apellido-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-apellidosciudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/nacionalidad-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-nacionalidadciudadano').attr('value', data);
  });

  $.get('index.php?r=regdiarioaf/etnia-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-etniaciudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/lugar-residencia-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-lugarresidenciaciudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/provincia-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-provinciaciudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/canton-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-cantonciudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/parroquia-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-parroquiaciudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/localidad-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-localidadciudadano').attr('value', data);
  });

  $.get('index.php?r=regdiarioaf/direccion-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-direccionciudadano').attr('value', data);
  });

  $.get('index.php?r=regdiarioaf/telefono-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-telefonociudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/cedula-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-cedulaciudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/sexo-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-sexociudadano').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/pertenece-ciudadano', {id : idCiudadano}, function(data){
      var data = $.parseJSON(data);
...
function establecimiento(idEstablecimiento){
  ...
  $.get('index.php?r=regdiarioaf/zona', {id : idEstablecimiento}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-zona').attr('value', data);
  });

  $.get('index.php?r=regdiarioaf/provincia', {id : idEstablecimiento}, function(data){

      var data = $.parseJSON(data);
      $('#regdiario-provincia').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/canton', {id : idEstablecimiento}, function(data){

      var data = $.parseJSON(data);
      $('#regdiario-canton').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/distrito', {id : idEstablecimiento}, function(data){

      var data = $.parseJSON(data);
      $('#regdiario-distrito').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/parroquia', {id : idEstablecimiento}, function(data){

      var data = $.parseJSON(data);
      $('#regdiario-parroquia').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/tipo-establecimiento', {id : idEstablecimiento}, function(data){

      var data = $.parseJSON(data);
      $('#regdiario-tipoestablecimiento').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/zona-ubicacion', {id : idEstablecimiento}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-zonaubicacion').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/localidad', {id : idEstablecimiento}, function(data){
      var data = $.parseJSON(data);
      $('#regdiario-localidad').attr('value', data);
  });
  $.get('index.php?r=regdiarioaf/uni-codigo', {id : idEstablecimiento}, function(data){
      var data = $.parseJSON(data);
...
function check(){
    ...
    //  $("select").bind("click", function(){
                ...
                $("#vacunacionregistrodiario-"+0+"-vacuna").change(function(){
                  ...
                  $.post("index.php?r=regdiarioaf/listado-dosis&id="+$(this).val(), function( data ){

                    $("select#vacunacionregistrodiario-"+0+"-coddosis").html( data );
                  });
                    $.post("index.php?r=regdiarioaf/listado-rango-edad&id="+$(this).val(), function( data ){
